...
export const actionStationDataFullfilled = createAction((data: OriginStationData) => ({
...
export const actionMetroRoutes = createAction((from: string, to: string) => ({
  type: ActionTypes.GET_METRO_ROUTES,
  from,
  to,
}));

export const actionUpdateStation = createAction((station: string, key: string) => ({
